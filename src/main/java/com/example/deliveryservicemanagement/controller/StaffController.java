...
public class StaffController {
    ...
    public String findStaffById(@RequestParam("id") int id, Model model) {
        ...
        Map<YearMonth, Integer> monthlyLeaves = staffService.calculateMonthlyLeaves(
                staffService.findStaffById(id));
    ...
    public String updateStaffData(@PathVariable int id,
    ...
    public String findStaffByName(@RequestParam("name") String name, Model model) {
        model.addAttribute("staffName",
                staffService.findStaffByName(name));
        return "staffDetails";
    }
...
//    }
    ...
    public String saveStaffLeave(@Valid @ModelAttribute("staffLeave") StaffLeave staffLeave,
                                 BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return "setLeave";
        }
    ...
    public String calculateSalary(@ModelAttribute("staffSalary") StaffSalary staffSalary,
                                  BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            return "calculateSalary";
        }
