...
public class StaffService {
    ...
    public void calculateTotalSalary(StaffSalary staffSalary) {
        ...
        List<StaffLeave> staffLeaves = staffLeaveDao
                .findByLeaveMonthAndLeaveYear(paymentMonth,
                        staffSalary.getPaymentDate().getYear());
    ...
    private int calculateBonus(StaffSalary staffSalary,
                               boolean hasLeave) {
